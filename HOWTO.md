# Welcome to Connect Extension project testingmwd
...
**$ docker compose run testingmwd_bash**
...
**$ docker compose run testingmwd_test**


## Scheduled Methods
In *testingmwd/extension.json* file you can find the following section:
```
"schedulables": [
    {
